...
Write-Host "⚙️  [3/7] Checking PM2..." -ForegroundColor Yellow
...
Write-Host "▶️  [5/7] Starting PM2 services..." -ForegroundColor Yellow
...
pm2 save
Write-Host "✅ PM2 config saved!" -ForegroundColor Green
Write-Host ""
